...
impl SMDHIcon {
    pub fn from_smdh<T: Read + Seek>(f: &mut T) -> Result<Self, Box<dyn std::error::Error>> {
    ...
    pub fn from_n3dsx<T: Read + Seek>(f: &mut T) -> Result<Self, Box<dyn std::error::Error>> {
    ...
    pub fn from_cia<T: Read + Seek>(f: &mut T) -> Result<Self, Box<dyn std::error::Error>> {
        /*
    ...
    pub fn from_cia_meta<T: Read + Seek>(f: &mut T) -> Result<Self, Box<dyn std::error::Error>> {
        f.seek(SeekFrom::Current(0x400))?;
        let smdh_icon = SMDHIcon::from_smdh(f)?;
        Ok(smdh_icon)
    }

    pub fn from_cci<T: Read + Seek>(f: &mut T) -> Result<Self, Box<dyn std::error::Error>> {
    ...
    pub fn from_cxi<T: Read + Seek>(f: &mut T) -> Result<Self, Box<dyn std::error::Error>> {
    ...
    pub fn from_exefs<T: Read + Seek>(f: &mut T) -> Result<Self, Box<dyn std::error::Error>> {
...
impl CCIPartition {
    pub fn from_data<T: Read + Seek>(f: &mut T) -> Result<Self, Box<dyn std::error::Error>> {
